...
# ============================================================
# Baseline YOLOv8n Training Script (NO modifications)
# ============================================================
if __name__ == "__main__":
    print("🔥 Training Baseline YOLOv8n on SSDD (No EdgeStem, No CBAM)")

    # Load vanilla YOLOv8n with pretrained COCO weights
    ...
    # -------------------------
    print("\n🔍 Validating Baseline YOLOv8n on val set...")
    metrics = model.val(device=device)

    rd = metrics.results_dict
    print("\n===== FINAL BASELINE YOLOv8n METRICS =====")
